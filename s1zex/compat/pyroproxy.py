...
import s1zextl
from s1zexpyro import Client as PyroClient
from s1zexpyro import errors as pyro_errors
from s1zexpyro import raw
...
PROXY = {
    pyro_object: s1zextl.tl.alltlobjects.tlobjects[constructor_id]
    for constructor_id, pyro_object in raw.all.objects.items()
    if constructor_id in s1zextl.tl.alltlobjects.tlobjects
}
...
REVERSED_PROXY = {
    ...
    **{
        ...
        for _, tl_object in utils.iter_attrs(s1zextl.tl.custom)
...
class PyroProxyClient(PyroClient):
    ...
    def __init__(self, tl_client: CustomTelegramClient):
        ...
        super().__init__(
            ...
            lang_code="en",
            in_memory=True,
            phone_number=tl_client.s1zex_me.phone,
        )
    ...
    def _on_event(
        self,
        event: typing.Union[
            s1zextl.tl.types.Updates,
            s1zextl.tl.types.UpdatesCombined,
            s1zextl.tl.types.UpdateShort,
        ],
    ):
    ...
    async def invoke(
        ...
        **kwargs,
        ...
        except s1zextl.errors.rpcerrorlist.RPCError as e:
    ...
    @staticmethod
    def _tl_error2pyro(
        error: s1zextl.errors.rpcerrorlist.RPCError,
    ...
    def _pyro2tl(self, pyro_obj: raw.core.TLObject) -> s1zextl.tl.TLObject:
        """
    ...
    def _tl2pyro(self, tl_obj: s1zextl.tl.TLObject) -> raw.core.TLObject:
        """
        ...
        if (
            ...
            tl_obj.from_id = s1zextl.tl.types.PeerUser(tl_obj.sender_id)
        ...
        if not isinstance(tl_obj, s1zextl.tl.TLObject):
            return tl_obj
    ...
    async def resolve_peer(
        ...
        *args,
        **kwargs,
    ) -> "typing.Union[s1zexpyro.raw.types.PeerChat, s1zexpyro.raw.types.PeerChannel, s1zexpyro.raw.types.PeerUser]":  # type: ignore  # noqa: E501, F821
        """
        ...
        :rtype: typing.Union[s1zexpyro.raw.types.PeerChat, s1zexpyro.raw.types.PeerChannel, s1zexpyro.raw.types.PeerUser]
        """
