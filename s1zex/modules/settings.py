...
class CoreMod(loader.Module):
    ...
    strings = {
        ...
        "s1zex": (
            "{} <b>{}.{}.{}</b> <i>{}</i>\n\n<b><emoji"
            " document_id=5377437404078546699>💜</emoji> <b>s1zex-TL:"
            "</b> <i>{}</i>\n{}"
            " <b>s1zex-Pyro:</b> <i>{}</i>\n"
            "<emoji document_id=5188666899860298925>🌒</emoji> <b>s1zex:</b> <i>V1.6.1</i>\n<emoji"
            " document_id=6327560044845991305>👾</emoji>"
            " <b>Developers: s1zex.t.me/3</b>"
        ),
        ...
        "prefix_collision": (
            "<emoji document_id=5469654973308476699>💣</emoji> <b>Your Dragon and s1zex"
    ...
    @loader.command(
        ru_doc="Показать версию s1zex",
    )
    async def s1zexcmd(self, message: Message):
        """Get s1zex version"""
        await utils.answer_file(
            message,
            "https://github.com/s1zexxx/userbot/assets/banner.png",
            self.strings("s1zex").format(
                (
                    (
