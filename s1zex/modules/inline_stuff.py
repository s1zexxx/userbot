...
class InlineStuffMod(loader.Module):
    ...
    strings = {
        ...
        "this_is_s1zex": (
            "🥀 <b>Hi! This is s1zex, UserBot that is based on the best UserBot s1zex. You can"
            " install it to your account!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/MXRRI/s1zex">GitHub</a></b>\n<b>🥀 <a'
            ' href="https://t.me/s1zexzxc">Чат поддержки</a></b>'
        ),
    }
    ...
    strings_ru = {
        ...
        "bot_updated": (
            ...
            " Для их применения нужно перезагрузить s1zex</b>"
        ),
        "this_is_s1zex": (
            "🥀 <b>Привет! Это s1zex, ЮзерБот основанный на s1zex. Вы можете"
            " установить на свой аккаунт!</b>\n\n<b>💎 <a"
            ' href="https://github.com/s1zexxx/userbot">GitHub</a></b>\n<b>🥀 <a'
            ' href="https://t.me/s1zexzxc">Чат поддержки</a></b>'
        ),
    }
    ...
    strings_uk = {
        ...
        "bot_updated": (
            ...
            " Для їх застосування потрібно перезавантажити s1zex</b>"
        ),
        "this_is_s1zex": (
            "🥀 <b>Привіт! Це s1zex, заснований на s1zex. Ви можете"
            " встановити на свій аккаунт!</b>\n\n<b>💎 <a"
            ' href="https://github.com/s1zexxx/userbot">GitHub</a></b>\n<b>🥀 <a'
            ' href="https://t.me/s1zexzxc">Чат підтримки</a></b>'
        ),
    }
    ...
    async def ch_s1zex_bot(self, message: Message):
        """<username> - Change your s1zex inline bot username"""
        ...
        self._db.set("s1zex.inline", "custom_bot", args)
        self._db.set("s1zex.inline", "bot_token", None)
    ...
    async def aiogram_watcher(self, message: BotInlineMessage):
        ...
        await message.answer_photo(
            ...
            caption=self.strings("this_is_s1zex"),
        )
