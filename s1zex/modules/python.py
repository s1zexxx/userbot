...
from ..log import s1zexException
...
class PythonMod(loader.Module):
    ...
    async def e(self, message: Message):
        ...
        try:
            ...
            item = s1zexException.from_exc_info(*sys.exc_info())
    ...
    def censor(self, ret: str) -> str:
        ret = ret.replace(str(self._client.s1zex_me.phone), "&lt;phone&gt;")
        ...
        if btoken := self._db.get("s1zex.inline", "bot_token", False):
            ret = ret.replace(
                btoken,
                f'{btoken.split(":")[0]}:{"*" * 26}',
            )
