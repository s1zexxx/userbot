...
class UpdaterMod(loader.Module):
    ...
    strings = {
        ...
        "update_confirm": (
            "❓ <b>Are you sure you"
            " want to update?\n\n<a"
            ' href="https://github.com/s1zexxx/userbot/{}">{}</a><a'
            ' href="https://github.com/s1zexxx/userbot/{}">{}</a></b>'
        ),
    ...
    strings_ru = {
        ...
        "update_confirm": (
            "❓ <b>Ты уверен, что"
            " хочешь обновиться??\n\n<a"
            ' href="https://github.com/s1zexxx/userbot/commit/{}">{}</a><a'
            ' href="https://github.com/s1zexxx/userbot/commit/{}">{}</a></b>'
        ),
    ...
    async def restart_common(
        ...
        msg_obj = await utils.answer(
            ...
            self.strings("restarting_caption").format(
                ...
                if self._client.s1zex_me.premium
                and CUSTOM_EMOJIS
...
#            ),
    ...
    async def _add_folder(self):
        ...
        if any(getattr(folder, "title", None) == "s1zex" for folder in folders):
            return
        ...
        try:
            ...
            logger.critical(
                "Can't create s1zex folder. Possible reasons are:\n"
