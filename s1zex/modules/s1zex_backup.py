...
@loader.tds
class s1zexBackupMod(loader.Module):
    ...
    strings_ru = {
        "period": (
            ...
            "</b>‼️<b> Не с кем не делитесь файлами конфига, даже с разработчиками s1zex! Они содержат конфиденциальные данные\n\n"
    ...
    async def client_ready(self):
        if not self.get("period"):
            await self.inline.bot.send_photo(
                self.tg_id,
                photo="https://github.com/s1zexxx/userbot/assets/BackUp.png",
    ...
    async def handler(self):
        try:
            ...
            backup.name = "s1zex-db-backup-{}.json".format(
            ...
            logger.exception("s1zexBackup failed")
