...
@loader.tds
class s1zexConfigMod(loader.Module):
    """Interactive configurator for s1zex Userbot"""
    ...
    strings_ru = {
        ...
        "_cls_doc": "Интерактивный конфигуратор s1zex",
    ...
    strings_uk = {
        ...
        "_cls_doc": "Інтерактивний конфігуратор s1zex",
