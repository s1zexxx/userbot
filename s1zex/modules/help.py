...
class HelpMod(loader.Module):
    ...
    strings_ru = {
        "undoc": "🦥 Нет описания",
        "support": (
            "{}\n\n <b>Ссылка на</b> <a href='https://t.me/s1zexzxc'>чат помощи</a></b>"
        ),
        ...
        "request_join": "Вы запросили ссылку на чат помощи s1zex",
        "core_notice": (
    ...
    strings_uk = {
        "undoc": "🦥 Немає опису",
        "support": (
            "{}\n\n <b>Посилання на</b> <a href='https://t.me/s1zexzxc'>чат допомоги</a></b>"
        ),
        ...
        "request_join": "Ви запросили посилання на чат допомоги s1zex",
        "core_notice": (
    ...
    @loader.command(ru_doc="Показать ссылку на чат помощи s1zex")
    async def support(self, message):
        """Get link of s1zex support chat"""
        if message.out:
            await self.request_join("@s1zexzxc", self.strings("request_join"))
        ...
        await utils.answer(
            ...
            self.strings("support").format(
                (
                    ...
                    if self._client.s1zex_me.premium and CUSTOM_EMOJIS
                    else "🥀"
                )
            ),
        )
